$list_editUrl = getPath()+"/projectm/pmPhoneright/edit";//编辑及查看url
$list_addUrl = getPath()+"/projectm/pmPhoneright/add";//新增url
$list_deleteUrl = getPath()+"/projectm/pmPhoneright/delRight";//删除url
...
$(document).ready(function(){
	...
	$list_dataGrid = $("#tableContainer").ligerGrid($.extend($list_defaultGridParam,{
        ...
        delayLoad:true,
        pageSize:30,
        url:getPath() + '/projectm/pmPhoneright/listData',
...
function doSetDefault(obj){
	...
	param['type'] = obj.type;
	$.post(getPath()+"/projectm/pmPhoneright/setDefault",param,function(res){
