$(document).ready(function(){
	$("#main").ligerLayout({});
	tb = $("#toolBar").ligerToolBar({
		items:[{id:'add',text:'查询',click:searchData,icon:'search2'}]
		});
	$list_dataGrid = $("#tableContainer").ligerGrid($.extend($list_defaultGridParam,{
        ...
        delayLoad:true,
        pageSize:30,
        url:getPath() + '/projectm/pmPhonenumber/getNumberList',
...
function searchData(){
	...
	if(searchKeyWord && searchKeyWord!=$("#searchKeyWord").attr("defaultValue")){
