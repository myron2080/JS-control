...
function renderStepIndex(){
	...
	$("#ul_signlist li[id^='li_step_']").each(function(i,stepObj){
		...
		if(i == (stepCount - 1)){
			$("#btnMove",stepObj).removeClass("icodown");
			$("#btnMove",stepObj).addClass("icoup");
		}else{
			$("#btnMove",stepObj).removeClass("icoup");
			$("#btnMove",stepObj).addClass("icodown");
		}
	});
}
/**
