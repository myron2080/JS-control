                      ...
                      '<div class="debate-reply">'+
	                      '<div class="debate-replyin">'+
                           ...
                           '<b class="colorblue">'+data[i].creatorName+'：</b>'+ convertImg(data[i].content)+
                           	   '</div>'+
                           	'</div>'+
                            '<div class="vote-listin06"><a class="vote-delete" href="javascript:void(0)"  onclick="deleteData(\''+data[i].id+'\')"></a></div>'+
                        '</div>'+
                        '<div class="debate-replyin"><b class="fl color999">'+data[i].creatorTime+'</b> <b class="fr colorblue">赞：'+data[i].praiseCount+'</b></div>'+
                      '</div>'+
                 '</div>'+
             '</li>';
