$list_addUrl = getPath()+"/interflow/portlet/add";
$list_editUrl = getPath()+"/interflow/portlet/edit";
$list_deleteUrl = getPath()+"/interflow/portlet/delete";
$list_editWidth = 650;
$list_editHeight = 200;
...
$(document).ready(function(){
	...
	$list_dataGrid = $("#tableContainer").ligerGrid($.extend($list_defaultGridParam,{
        columns: [ 
           ...
           // enabledSort :true,    
            paging:true,
        url:getPath() + '/interflow/portlet/listData'
    }));  
	//resetList();
});
...
function updateStatus(id,status){
	$.post(getPath()+"/interflow/portlet/updateStatus",{id:id,status:status},function(res){
