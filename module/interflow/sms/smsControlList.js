$list_editUrl = getPath()+"/interflow/smsControl/editPersonalControl";//编辑及查看url
$list_addUrl = getPath()+"/interflow/smsControl/add";//新增url
$list_deleteUrl = getPath()+"/interflow/smsControl/delete";//删除url
$list_editWidth = 450;
$list_editHeight = 140;

$list_dataType = "短信控制";//数据名称
$tree_container = "leftTree";
$tree_async_url = getPath()+"/interflow/smsControl/treeDataAll";
$(document).ready(function(){
	...
	$list_dataGrid = $("#tableContainer").ligerGrid($.extend($list_defaultGridParam,{
        ...
        url:getPath()+'/interflow/smsControl/listData',
        delayLoad:true,
        height:"96%",
        usePager:true,
        enabledSort:false
...
function sendMessage(senderId){
		...
		$.post(getPath()+"/interflow/smsControl/sendMessage",{senderId:senderId},function(data){
...
function toConfigBtn(){
  ...
  var url = getPath()+"/interflow/smsControl/toSmsConfig";		 
  var flag = true;
...
function changeBalance(param){
	var u = getPath()+"/interflow/smsControl/toChangeBalance";
...
function viewSMSControlHistory(param){
	var u = getPath()+"/interflow/smsControl/toControlHistory";
