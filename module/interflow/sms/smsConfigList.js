...
function saveEdit(){
   ...
   if(flag){
	   $.post(getPath()+"/interflow/smsControl/saveSmsConfig",{smsConfigJson:JSON.stringify(smsConfigJson)},function(data){
...
function updateEnableFlag(id,enableFlag){
   ...
   if(flag){
	   $.post(getPath()+"/interflow/smsControl/updateEnableFlag",{id:id,enableFlag:enableFlag},function(data){
		   if("SUCCESS"==data.STATE) {
