...
function initData(page){
	$.post(getPath()+"/cmct/messageReply/getData",{page:page},function(pag){
		var list = pag.items;
...
function showDetail(mobile){
	var dlg = art.dialog.open(getPath()+"/cmct/messageReply/toDetail?mobile="+mobile,{
		id : 'detail',
		title:"短信详情",
		width : 600,
		height : 340,
