...
function updateEnableFlag(id,enableFlag){
	...
	$.post(getPath()+"/permission/menu/updateEnableFlag",{id:id,enableFlag:enableFlag},function(data){
...
function initMenuData(page){
	...
	$.post(getPath()+"/permission/menu/listMenuL1",param,function(data){ 
...
function addMenuL1(){ 
	var $list_addUrl =  getPath()+"/permission/menu/addMenuL1";
	var flag = true;
...
function editMenuL1(){ 
	...
	var $list_addUrl =  getPath()+"/permission/menu/editMenuL1?id="+parentMenuId;
	var flag = true;
	var dlg = art.dialog.open($list_addUrl,
			{title:"修改一级菜单",
			 lock:true,
