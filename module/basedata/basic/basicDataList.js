$list_editUrl = getPath()+"/basedata/basic/basicdata/edit";//编辑及查看url
$list_addUrl = getPath()+"/basedata/basic/basicdata/add";//新增url
$list_deleteUrl = getPath()+"/basedata/basic/basicdata/delete";//删除url
$list_editWidth = "580px";
$list_editHeight = "270px";
$list_dataType = "基础数据";//数据名称
$tree_container = "leftTree";
$tree_addUrl = getPath()+"/basedata/basic/datatype/add";//新增
$tree_async_url = getPath()+"/basedata/basic/datatype/simpleTreeData";
$tree_editUrl = getPath()+"/basedata/basic/datatype/edit";//编辑及查看url
$tree_deleteUrl = getPath()+"/basedata/basic/datatype/delete";//删除url
...
$(document).ready(function(){
	...
	$list_dataGrid = $("#tableContainer").ligerGrid($.extend($list_defaultGridParam,{
        columns: [ 
            {display: '类型', name: 'type.name', align: 'left', width: 120},
        ...
        height:'95%',
        url:getPath()+'/basedata/basic/basicdata/listData',
        delayLoad:true
    }));
	
	/*$("[toolbarid='updateNode']").hide();
	$("[toolbarid='deleteNode']").hide();*/
...
function enable(data){
	$.post(getPath()+"/basedata/basic/basicdata/enable",data,function(res){
