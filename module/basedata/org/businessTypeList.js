$list_editUrl = getPath()+"/basedata/businessType/edit";//编辑及查看url
$list_addUrl = getPath()+"/basedata/businessType/add";//新增url
$list_deleteUrl = getPath()+"/basedata/businessType/delete";//删除url
$list_editWidth = "580px";
$list_editHeight = "250px";
$list_dataType = "业务类型";//数据名称
$tree_container = "leftTree";
$tree_async_url = getPath()+"/basedata/businessType/simpleTreeData";
$(document).ready(function(){
	...
	$list_dataGrid = $("#tableContainer").ligerGrid($.extend($list_defaultGridParam,{
        ...
        url:getPath()+'/basedata/businessType/listData',
        delayLoad:true
    }));
});
...
function enable(data){
	$.post(getPath()+"/basedata/businessType/enable",data,function(res){
