(function ($)
{
    ...
    $.fn.ligerOrgBox = function (options)
    {
        return $.ligerui.run.call(this, "ligerOrgBox", arguments);
    };

    $.fn.ligerGetOrgBoxManager = function ()
    {
        return $.ligerui.run.call(this, "ligerGetOrgBoxManager", arguments);
    };

    $.ligerDefaults.OrgBox = {
        resize: true,           //是否调整大小
        ...
        url:getPath()+"/basedata/org/simpleTreeData",              //数据源URL(需返回JSON)
        onSuccess: null,
        onError: null,
        ...
        remoteParam:null,
        maxitem:10 //普通下拉最大条数,超过则以树构建
    };

    //扩展方法
    $.ligerMethos.OrgBox = $.ligerMethos.OrgBox || {};


    $.ligerui.controls.OrgBox = function (element, options)
    {
        $.ligerui.controls.OrgBox.base.constructor.call(this, element, options);
    };
    $.ligerui.controls.OrgBox.ligerExtend($.ligerui.controls.Input, {
        __getType: function ()
        {
            return 'OrgBox';
        },
        ...
        {
            return $.ligerMethos.OrgBox;
        },
        _init: function ()
        {
            $.ligerui.controls.OrgBox.base._init.call(this);
            var p = this.options;
            if (p.columns)
            {
    ...
    $.ligerui.controls.OrgBox.prototype.setValue = $.ligerui.controls.OrgBox.prototype.selectValue;
    //设置文本框和隐藏控件的值
    $.ligerui.controls.OrgBox.prototype.setInputValue = $.ligerui.controls.OrgBox.prototype._changeValue;
