...
$.widget( "mobile.dialog", $.mobile.widget, {
	...
	_setCloseBtn: function( value ) {
		...
		if ( value !== "none" ) {
			...
			btn = $( "<a href='javascript:void(0)' class='ui-btn-" + location + "' data-" + $.mobile.ns + "icon='delete' data-" + $.mobile.ns + "iconpos='notext'>"+ this.options.closeBtnText + "</a>" );
...
$.widget( "mobile.collapsible", $.mobile.widget, {
	...
	_create: function() {
		...
		collapsibleHeading
			...
			.wrapInner( "<a href='javascript:void(0)' class='ui-collapsible-heading-toggle'></a>" )
			.find( "a" )
				.first()
				.buttonMarkup({
					shadow: false,
...
$.widget( "mobile.textinput", $.mobile.widget, {
	...
	_create: function() {
		...
		if( inputNeedsClearBtn || isSearch ) {
			clearbtn = $( "<a href='javascript:void(0)' class='ui-input-clear' title='" + clearBtnText + "'>" + clearBtnText + "</a>" )
				.bind( "click", function( event ) {
					input
						.val( "" )
						.focus()
