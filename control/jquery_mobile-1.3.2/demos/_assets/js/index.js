				...
				var self = this,
					...
					this.element.find("div.jqm-content>h2").each(function(){
						...
						if(!first){
							...
							$(this).before("<a href='javascript:void(0)' data-ajax='false' class='jqm-deeplink ui-link jqm-open-quicklink-panel'>Jump to section<span class='ui-icon ui-icon-bars'>&nbsp;</span></a>");
						}
						first = false;
					});
